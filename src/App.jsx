...
const SUMMARY_PIN_FONT_SIZE = 16; // at-bat number printed inside the dot (elsewhere it's 7.5)
...
const SUMMARY_ATBATINFO_COL_WIDTH = 25.8; // Player / at-bat-list column
const SUMMARY_NOTES_COL_WIDTH = 14.2; // Notes column
...
function GlobalStyles() {
  return (
    <style>{`
      ...
      .summary-player-stats { font-size:10px; font-weight:700; color:${COLORS.ink}; white-space:nowrap; }
